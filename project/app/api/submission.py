...
from app.utils.database.database import get_db, engine
from app.utils.database import models, schemas
from app.api.models.request_models import Submission, ImageSubmission
...
async def submission_text(sub: Submission, Depends(get_db)):
